                              ...
                              <div class="col-sm-12">
                                <div class="mb-3 row" id="-email">
                                  ...
                                  <div class="col-sm-4 noHP">
                                    <input required type="number" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') }}">
                                    @error('no_hp')
                                  ...
                                  <div class="col-sm-4 email">
                                    <input required type="email" class="mb-3 form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" autocomplete="email">
                                    @error('email')
                                  ...
                                  <div class="col-sm-4">
                                    <input id="npm" style="display: none;" type="text" class="mb-3 form-control @error('npm') is-invalid @enderror" value="{{ old('npm') }}" name="npm" autocomplete="npm">
                                    @error('npm')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                  </div>
