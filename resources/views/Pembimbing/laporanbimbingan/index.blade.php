...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h2 class="mt-4">Pencatatan Bimbingan</h2>
                <h5 class="breadcrumb-item active">Dashboard &raquo; Pencatatan Bimbingan</h5>
            </div>
                            ...
                            <tbody>
                                @foreach ($pemagangan as $p)
                                    <tr>
                                        ...
                                        <td>
                                                <a href="/laporanbimbinganpembimbing/show/{{ $p->user_id }}/" class="text-white text-decoration-none">
