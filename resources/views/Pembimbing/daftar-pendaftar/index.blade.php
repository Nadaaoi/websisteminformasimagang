            ...
            <div class="card-body overflow-auto">
                <div class="row">
                    <!--<div class="row">-->
                        <div class="col-12">
                            <form action="{{ route('daftar-pendaftar.index') }}" method="GET" class="d-flex flex-column ">
                                ...
                                <div class="mb-2">
                                    <button type="submit" class="btn btn-sm btn-primary rounded-3" style="width: 20%;">Filter</button>
                                </div>
                            </form>
                        </div>
                    <!--</div> -->
                    ...
                    <div class="col-12">
                        ...
                        <table id="order-listing" class="display expandable-table" style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    {{-- <th>Pengajuan</th> --}}
