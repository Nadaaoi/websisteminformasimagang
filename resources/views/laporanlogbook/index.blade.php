                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-group">
                                                <a href="/laporanlogbook/show/{{ $p->user_id }}" class="button-link">
                                                    <button type="button" class="btn btn-warning" title="Lihat data">
                                                        <i class="bi bi-eye"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('laporanlogbook.showpdf', ['user_id' => $p->user_id]) }}" class="button-link">
                                                    <button type="button" class="btn btn-info" title="Unggah PDF">
                                                        <i class="bi bi-filetype-pdf"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('laporanlogbook.showexcel', ['user_id' => $p->user_id]) }}" class="button-link">
