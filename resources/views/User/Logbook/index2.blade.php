...
@section('css')
    <style>
        ...
        /* Gunakan unit ukuran viewport untuk card dan modal */
        .card {
            width: 30vw;
            height: 65vh;
        }
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card" style="background-color: #00923F">
                <div class="card-body" style="color: #ffff">
                    ...
                    <p class="card-text">Isilah logbook harian berdasarkan waktu yang telah ditentukan!</p>
                    @foreach ($days as $day)
        ...
        <div class="col-md-7">
            @foreach ($days as $day)
            <div class="card mb-3" style="width: 43vw; height: 35vh;">
                <div class="card-body">
                            ...
                            <form action="/logbook/store" method="POST">
                                ...
                                <div class="form-group" id="alasan-form-{{ $loop->index }}" style="display: none;">
                                    ...
                                    <select class="form-control" name="alasan_ketidakhadiran" id="absent_reason-{{ $loop->index }}">
                                        ...
                                        <option value="liburnasional">Hari libur nasional</option>
                                    </select>
                                </div>
                        </div>
...
{{-- <script>
    function viewLogbook(status, deskripsiTugas, alasanKetidakhadiran) {
        ...
        if (status === 'Hadir') {
            ...
            viewStatusKehadiran.classList.remove('text-danger'); // Remove "Tidak hadir" class
            ...
            viewStatusKehadiran.classList.remove('text-success'); // Remove "Hadir" class
        }

        // Set the text content for status
